...
:setvar DefaultDataPath "C:\Program Files\Microsoft SQL Server\MSSQL11.DEV\MSSQL\DATA\"
:setvar DefaultLogPath "C:\Program Files\Microsoft SQL Server\MSSQL11.DEV\MSSQL\DATA\"
...
GO
ALTER DATABASE [$(DatabaseName)]
    ADD FILE (NAME = [ContentDBFSGroup_8BBD64F], FILENAME = N'$(DefaultDataPath)$(DefaultFilePrefix)_ContentDBFSGroup_8BBD64F.mdf') TO FILEGROUP [ContentDBFSGroup];
