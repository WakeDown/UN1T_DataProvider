/*
Скрипт развертывания для SpeCalcDb
...
GO
:setvar DatabaseName "SpeCalcDb"
:setvar DefaultFilePrefix "SpeCalcDb"
...
GO
ALTER DATABASE [$(DatabaseName)]
    ADD FILE (NAME = [ContentDBFSGroup_72D8967D], FILENAME = N'$(DefaultDataPath)$(DefaultFilePrefix)_ContentDBFSGroup_72D8967D.mdf') TO FILEGROUP [ContentDBFSGroup];
