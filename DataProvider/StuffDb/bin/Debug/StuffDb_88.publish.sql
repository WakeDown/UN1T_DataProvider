...
GO
PRINT N'Выполняется изменение [dbo].[close_employee]...';


GO
ALTER PROCEDURE [dbo].[close_employee] @id INT
AS
    BEGIN
        SET NOCOUNT ON;
        UPDATE  employees
    ...
    END
GO
PRINT N'Выполняется изменение [dbo].[close_organization]...';


GO
ALTER PROCEDURE [dbo].[close_organization] @id INT
AS
    BEGIN
        SET NOCOUNT ON;
    ...
    END
GO
PRINT N'Выполняется изменение [dbo].[close_position]...';


GO
ALTER PROCEDURE [dbo].[close_position] @id INT
AS
    BEGIN
        SET NOCOUNT ON;
        UPDATE  positions
