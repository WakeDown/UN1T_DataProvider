...
GO
PRINT N'Указанная ниже операция создана из файла журнала рефакторинга ac0d019b-3346-4300-a96e-cb6766d554c5';

PRINT N'Переименование [dbo].[employees].[full_name_vin] в full_name_rod';
...
GO
ALTER TABLE [dbo].[positions] DROP COLUMN [name_vin];
