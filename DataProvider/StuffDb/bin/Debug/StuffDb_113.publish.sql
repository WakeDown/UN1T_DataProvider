...
GO
PRINT N'Выполняется изменение [dbo].[get_employees_newbie]...';
...
AS
    BEGIN
        SET NOCOUNT ON;
		SELECT full_name, position,city,department, date_create 
		FROM employees_view where convert(date,date_create) = @date_create
    END
GO
/*
