...
GO
PRINT N'Выполняется изменение [dbo].[org_state_images]...';


GO
ALTER TABLE [dbo].[org_state_images]
    ADD [dattim1] DATETIME DEFAULT getdate() NOT NULL,
...
AS
    ...
    END
GO
PRINT N'Выполняется обновление [dbo].[get_org_state_images]...';


GO
EXECUTE sp_refreshsqlmodule N'[dbo].[get_org_state_images]';


GO
PRINT N'Выполняется обновление [dbo].[save_org_state_image]...';


GO
EXECUTE sp_refreshsqlmodule N'[dbo].[save_org_state_image]';
