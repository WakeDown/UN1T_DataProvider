...
--текущий год
	...
	--т.к. не уверен на каком языке будет выполняться данная функция, то хардкодим пятницу, субботу и воскресенье
        SET @friday_name = DATENAME(weekday, convert(date,'2013-04-10'))
-- точно пятница
        SET @saturday_name = DATENAME(weekday, convert(date,'2013-05-10'))
-- точно суббота
        SET @sunday_name = DATENAME(weekday, convert(date,'2013-06-10'))
-- точно воскресенье
