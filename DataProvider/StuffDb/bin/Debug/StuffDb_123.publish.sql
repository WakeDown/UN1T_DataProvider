...
GO
PRINT N'Выполняется изменение [dbo].[get_city]...';


GO
ALTER PROCEDURE [dbo].[get_city]
	@id int = null
...
GO
PRINT N'Выполняется изменение [dbo].[get_organization_link_count]...';


GO
ALTER PROCEDURE [dbo].[get_organization_link_count]
(
	@id int
)
AS
...
GO
PRINT N'Выполняется изменение [dbo].[get_position_link_count]...';


GO
ALTER Procedure [dbo].[get_position_link_count]
(
	@id int
)
AS
