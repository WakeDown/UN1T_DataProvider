...
namespace DataProvider.Models.Stuff
{
    public class Organization : DbModel
    {
        ...
        public void Save()
        {
            ...
            var dt = Db.Stuff.ExecuteQueryStoredProcedure("save_organization", pId, pName, pCreatorAdSid, pAddressUr, pAddressFact, pPhone, pEmail, pInn, pKpp, pOgrn, pRs, pBank, pKs, pBik, pOkpo, pOkved, pManagerName, pManagerNameDat, pManagerPosition, pManagerPositionDat);
            if (dt.Rows.Count > 0)
            {
                int id;
