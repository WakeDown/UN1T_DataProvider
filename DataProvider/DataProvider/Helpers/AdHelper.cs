...
namespace DataProvider.Helpers
{
    public class AdHelper
    {
        ...
        //    }
        //}
        public static string SaveUser(ref Employee emp)
        {
            ...
            string managerUsername = String.IsNullOrEmpty(manager.AdLogin) ? GetLoginFromEmail(manager.Email) : manager.AdLogin;
            ...
            if (!String.IsNullOrEmpty(managerUsername.Trim()))
            {
                using (directoryEntry)
                {
                    ...
                    if (resultManager != null) managerName = (string)resultManager.Properties["DistinguishedName"][0];
                }
            }
